...
if(FSDK_FOUND)
	...
	if(FSDK_LIBD)
		...
		endforeach()
		message(STATUS "FSDK [INFO]: Debug FSDK libraries are available.")
	elseif(FSDK_LIB)
		foreach(LIB ${FSDK_LIB})
			list(APPEND FSDK_LIBRARIES debug ${LIB})
		endforeach()
		message(STATUS "FSDK [WARN]: Debug FSDK libraries are NOT available.")
	endif()
	# add vlf
	if(${FSDK_FIND_VLF})
	...
	if(${FSDK_FIND_VLFD})
		...
		message(STATUS "FSDK [INFO]: Debug vlf libraries are available.")
	else()
		list(APPEND FSDK_LIBRARIES debug ${VLF_LIB})
		message(STATUS "FSDK [WARN]: Debug vlf libraries are NOT available.")
	endif()
